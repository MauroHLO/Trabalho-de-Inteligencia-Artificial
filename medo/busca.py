...
class Busca:
    ...
    def verificaAntepassados(self, no: No, estadoAtual: Set[int]):
    ...
    # -------------------------
    def heuristica(self, estado: Set[int], objetivo: Set[int]):
        # Quantos predicados do objetivo faltam
        return len(objetivo - estado)
